...
def main():
    ...
    print(conf)
    TRAIN_DIR = conf.get("COVNet_18", "train") 
    VALID_DIR = conf.get("COVNet_18", "valid") 
    TEST_DIR = conf.get("COVNet_18", "test") 
    LOG_DIR = conf.get("COVNet_18", "log") 
