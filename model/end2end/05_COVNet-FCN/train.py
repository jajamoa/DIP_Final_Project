...
def main():
    ...
    print(conf)
    TRAIN_DIR = conf.get("COVNet_FCN", "train") 
    VALID_DIR = conf.get("COVNet_FCN", "valid") 
    TEST_DIR = conf.get("COVNet_FCN", "test") 
    LOG_DIR = conf.get("COVNet_FCN", "log") 
