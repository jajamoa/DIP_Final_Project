...
def main():
    ...
    print(conf)
    TRAIN_DIR = conf.get("COVNet_ECA", "train") 
    VALID_DIR = conf.get("COVNet_ECA", "valid") 
    TEST_DIR = conf.get("COVNet_ECA", "test") 
    LOG_DIR = conf.get("COVNet_ECA", "log") 
