...
def main():
    ...
    print(conf)
    TRAIN_DIR = conf.get("COVNet_CSR_HIGH", "train") 
    VALID_DIR = conf.get("COVNet_CSR_HIGH", "valid") 
    TEST_DIR = conf.get("COVNet_CSR_HIGH", "test") 
    LOG_DIR = conf.get("COVNet_CSR_HIGH", "log") 
