...
def main():
    ...
    print(conf)
    TRAIN_DIR = conf.get("COVNet_34", "train") 
    VALID_DIR = conf.get("COVNet_34", "valid") 
    TEST_DIR = conf.get("COVNet_34", "test") 
    LOG_DIR = conf.get("COVNet_34", "log") 
