...
def main():
    ...
    print(conf)
    TRAIN_DIR = conf.get("COVNet_CBAM", "train") 
    VALID_DIR = conf.get("COVNet_CBAM", "valid") 
    TEST_DIR = conf.get("COVNet_CBAM", "test") 
    LOG_DIR = conf.get("COVNet_CBAM", "log") 
...
def train(train_list, model, criterion, optimizer, epoch):
    ...
    train_loader = torch.utils.data.DataLoader(dataset.listDataset(train_list, train = False), num_workers=args.workers, batch_size=args.batch_size, shuffle = True)
